...
\begin{table}[H]
	...
	\begin{tabular}{|r |c|} 
		...
		\hline
		\textbf{1.1: Electrical Components} &  \\
		\hline
		\textbf{1.2: Control Software} &  \\
		\hline
		\textbf{1.3: Interface Software} & \\
		\hline
		\textbf{1.4: System Testing} & \\
		\hline
		\textbf{1.5: Integration Testing} & \\
		\hline
		\textbf{1.6: Unit Testing} & \\
		\hline 
	\end{tabular}
\end{table}
